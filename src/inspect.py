...
def visualize_model_generation(model, source_gen, target_gen, n_samples, key, dt=0.001, name=None):
    '''
    ...
    generated_samples = model.generate(noise_samples, key=key, dt=dt)
